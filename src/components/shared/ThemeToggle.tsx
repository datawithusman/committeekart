...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      title={theme === "light" ? "Dark mode on karein" : "Light mode on karein"}
      className="flex h-8 w-8 items-center justify-center rounded-lg border border-border text-foreground hover:bg-muted-light"
    >
      {theme === "light" ? (
